...
### Dependencies 
Compiler: GCC. These libraries are required: libc, pthread, libmatio. GCC installation usually includes the first two. Install libmatio in Ubuntu Linux with: `sudo apt update` and then `sudo apt install libmatio-dev`.
