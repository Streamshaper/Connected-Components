...
### Dependencies 
Compiler: GCC. These libraries are required: libc, libmatio. GCC installation usually includes libc. Install libmatio in Ubuntu Linux with: `sudo apt update` and then `sudo apt install libmatio-dev`.
